...
plt.title('Count of Speech', size=16)
sns.countplot(data_path.Speech)
plt.ylabel('Count', size=12)
plt.xlabel('Speech', size=12)
...
model.add(layers.Bidirectional(layers.LSTM(64, return_sequences=True), input_shape=(None,1)))
...
model=load_model('/content/drive/MyDrive/Project/model3.h5')
...
np.save('/content/drive/MyDrive/Project/file_stp3.npy', data)